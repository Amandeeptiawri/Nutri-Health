          ...
          <div className="row">
            <div className="col-lg-3 col-12 pb-5">
             <h1>NutriHealth</h1>
              ...
              We are dedicated to providing crucial nutrition facts and individual health advisory.
              </p>
            ...
            <div className="col-lg-3 col-md-4 col-6">
              <h5 className="text-uppercase pb-3">Recent Articles</h5>
            ...
            <div className="col-lg-3 col-md-4 col-6">
              <h5 className="text-uppercase pb-3">Recent Books</h5>
              <ul className="list-unstyled">
              ...
              >
                  ...
                  <defs>
                    <clipPath id="clip0_11807_2054">
                      <rect
                        ...
                        height="20"
                        fill="white"
                        transform="translate(0.666626 0.179688)"
                      />
                    </clipPath>
                  </defs>
                </svg>
                ...
                <button type="submit" className="submit-arrow">
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_11807_2057)">
                      <path
                        d="M19.8283 0.351335C19.6625 0.185554 19.4138 0.134577 19.1963 0.221608L0.368218 7.75277C0.152789 7.83894 0.00853097 8.04409 0.00024974 8.27601C-0.00799243 8.50788 0.121382 8.72276 0.330132 8.82401L7.75465 12.4248L11.3555 19.8493C11.4537 20.0518 11.6588 20.1796 11.8826 20.1796C11.8895 20.1796 11.8965 20.1795 11.9035 20.1792C12.1353 20.171 12.3406 20.0267 12.4267 19.8113L19.9579 0.983287C20.045 0.765631 19.994 0.517077 19.8283 0.351335ZM2.03478 8.34831L16.9811 2.36985L8.07371 11.2771L2.03478 8.34831ZM11.8312 18.1447L8.90234 12.1057L17.8097 3.19844L11.8312 18.1447Z"
                        fill="white"
                      />
                    </g>
                    <defs>
